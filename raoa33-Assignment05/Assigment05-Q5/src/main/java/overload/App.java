...
public class App {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            cars.add(new HybridCar("Hybrid Car", "Model " + i, 200+2*i, 50 + 2*i, 60 + 2*i, 50 + 2*i));
            cars.add(new HybridCar("Hybrid Car", "Model " + i, 150+2*i, 50 + 2*i, true));
            cars.add(new HybridCar("Hybrid Car", "Model " + i, 200+2*i, 60 + 2*i, false));
        }
